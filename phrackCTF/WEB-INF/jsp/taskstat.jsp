                                        ...
                                        <tbody>
                                            ...
                                            <tr <c:if test="${ pt.order==1 }">class="danger"</c:if>>
                                            	<td><c:if test="${ pt.order==1 }"><img src="images/fb.png" title="First Blood" width="20" height="20"/>&nbsp;&nbsp;&nbsp;</c:if><a class="text-muted"
													style="text-decoration: none;" href="profile/${ pt.solverid }" target="_blank">${ pt.solvername }</a>&nbsp;&nbsp;<a target="_blank" href="country/${ pt.countrycode }" style="text-decoration:none;">
