    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navigator">
                ...
                <ul class="nav navbar-nav navbar-right navbar-collapse">
                    <li class="dropdown">
                        <a href="${ctrlname}<%=(queryString!=null?("?"+queryString):"")%>#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="icon-user"></i> ${nickname} <strong>(Score:<span id="userscore">${score}</span> Rank:<span id="userrank">${rank}</span>)</strong><span class="caret"></span></a>
