					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<div class="text-muted bootstrap-admin-box-title">
								<strong>Ranklist</strong><a href="scoretrend.json" style="text-decoration:none;">
										...
										<c:forEach items="${ scorelist }" var="sb">
											<tr
												...
												<td><a class="text-muted"
													style="text-decoration: none;" href="profile/${ sb.userid }">${ sb.username }</a>&nbsp;&nbsp;<a href="country/${ sb.countrycode }" style="text-decoration:none;">
